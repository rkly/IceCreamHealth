...
namespace IceCream.View2
{
    public partial class StationsView2 : Form, IStationsView
    {
        public StationsView2()
        {
            InitializeComponent(); 
        }
        ...
        {
            if (this.gridstations.SelectedItems.Count > 0)
                this._controller.SelectedStationChanged(this.gridstations.SelectedItems[0].Text,1);
        }
        private void btnAdd_Click(object sender, EventArgs e)
        {
            this._controller.AddNewStation(1);
        }
        private void btnSave_Click(object sender, EventArgs e)
        {
            this._controller.Save(1);
        }
        private void btnRemove_Click(object sender, EventArgs e)
        {
            this._controller.RemoveStation(1);
        }
